...
def main():
    ...
    age = st.number_input('Masukkan Umur', min_value=17, max_value=100, value=30)
    trestbps = st.number_input("Tekanan Darah (restbp)", min_value=90, max_value=200, value=120)
    chol = st.number_input("Kolestrol", 100, 600, 200)
    thalach = st.number_input("Tekanan Darah Maksimal (thalach)", 100, 200, 150)
